...
{
    class potencialRiscoController : ControllerGenerics<potencial_risco>
    {
        public retornoApi ValidaDados(int id, string txtDescricao, int? idPontoCritico, bool ativo, bool cadastrar, string txtRastrear, bool seJaExistirUmregistroIdenticoRetornarOIDeEncerrar)
        {
            ...
            IRepository<potencial_risco> repository = new Repository<potencial_risco>();
            potencial_risco obj = new potencial_risco();
            ...
            else if (txtDescricao.Length > 500)
                objRetorno.Message = "Limite de Caracteres excedido! Máximo 500!";
        ...
        private retornoApi preencheObj(string txtDescricao, int pontoCritico, bool ativo, bool cadastrar, string txtRastrear,
            ref potencial_risco obj, IRepository<potencial_risco> repository)
        {
